...
If we are going to search for 'adaptive' genetic variance that has anything to do with a phenotype, we need to know a thing or two about quantitative genetics.

<div class="card">
<a href="Lectures/LG5_1_Quantitative_Genetics/index.html" target="new">
  <img src="media/LG5_1.png" alt="Slide Title" style="width:100%">
</a>
</div>
...
## Outliers and Gradients

At last, we delve into a bit of the outlier detection methods often associated with *Landscape Genetic* studies.  In this lecture we discuss what they are and some of the things you need to be congnicent of as we perform these kinds of anlayses.

<div class="card">
<a href="Lectures/LG5_2_Outliers_Gradients/index.html" target="new">
  <img src="media/LG5_2.png" alt="Slide Title" style="width:100%">
</a>
</div>
...
Since the beginning of evolutionary biology, we have been interested in developing tools for understanding adaptive genetic variation.  Landscape genomics (nee population genomics *sensu lato*) has been pushing the technology forward towards looking at adaptive variance and making great advancements.  However, evolutionary changes operate through phenotypes, not outlier loci.  In this section, we examine a bit of data covering quantitative genetics and explore some reasons why we should care about quantititve genetics and how it can help us understand where all this adaptive variance is hiding.

## Objectives 

In this activity, we will explore some basic approahces focusing on aspects of adaptive genetic variance. These include:  

1. Understand the limits to trait evolution as it is mediated through heritablity.
2. 
...
```{r echo=FALSE}
load("./data/dogwood/seedlings.rda")
