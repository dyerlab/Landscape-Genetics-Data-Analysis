...
In R, the gstudio package defined the genotype as just another kind of data type, one that can be contained within `data.frame`, `list`, and `vector` objects just like any other.
