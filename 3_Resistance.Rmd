...
If forced, most practitioners would have to admit that the *sine qua non* of landscape genetics is the use of ecological resistance in their analyese.  At a base level, if it weren't for resistance modeling, there is literally nothing to distinguish what we do in landscape genetics from the activities normally ascribed to population genetics (see Dyer 2015).  In this lecture, we introduce how to create ecological/spatial/environmental resistance models that we will subsequently include in our analyses as sets of potential predictor variables with the genetic response data.

<div class="card">
<a href="Lectures/LG3_1_Resistance_Models/index.html" target="new">
  <img src="media/LG3_1.png" alt="Slide Title" style="width:100%">
</a>
</div>
...
This lecture pulls it all together, taking the spatial/ecological data and the genetic data and start formulating the statistical mechanisms by which we attempt to determine which subset and under which conditions landscape features influence genetic connectivity.

<div class="card">
<a href="Lectures/LG3_2_Statistical_Inferences/index.html" target="new">
  <img src="media/LG3_2.png" alt="Slide Title" style="width:100%">
</a>
</div>
...
```{r echo=FALSE,fig.cap="Mirror resistance rasters based upon the presence of conifer canopy structure.", message=FALSE}
require(raster)
require(ggplot2)
...
## Getting Plot-Level Parameters

TODO: Add plot-level parameters here.
